-- supabase/migrations/20250722_update_filtered_reviews_rpc.sql

-- This migration updates the `get_filtered_reviews` RPC function
-- to include the `moderation_status` for comments.
            ...
            (
                SELECT jsonb_agg(
                    jsonb_build_object(
                        ...
                        ''moderation_status'', rc.moderation_status, -- ADDED: Include moderation_status for comments
